...
import { loginTeacher } from "../utils/APIRoutes";
          ...
          >
            <div className="flex">
              <div className="mt-[23px]">
                ...
                <span
                  className="text-xs ml-[120px] text-green-500 transition-all duration-300 cursor-pointer hover:text-green-700"
            ...
            <div className="mt-12 flex justify-evenly items-center">
              <button
                ...
                type="submit"
                className="font-bold flex items-center justify-center w-20 font-Crimson text-lg text-white bg-emerald-500 uppercase rounded cursor-pointer hover:bg-green-300 hover:shadow-3xl hover:text-green-500 transition-all duration-700 dark:text-white bg-transparent p-2 px-5 dark:bg-green-700 dark:hover:bg-green-900"
