...
import { contact } from "../utils/APIRoutes";
...
const Contact = () => {
  ...
  useEffect(() => {
    document.title = "GURUCOOOL : CONTACT "; // Set the title of the web page
  }, []);
  ...
  return (
    <>
      ...
      <div
        className={
          "antialiased dark:bg-slate-600 bg-gray-100 h-full transition-all duration-1000"
        }
      >
          ...
          >
            <div className="flex flex-col space-y-8 justify-between">
              ...
              <div className="flex space-x-4 text-lg ">
                <Link to={"https://www.facebook.com/groups/573143149428004/"}>
                  <i className="fa-brands fa-facebook hover:text-blue-500"></i>
                </Link>
                <Link
                  to={"https://www.instagram.com/vidya.bhawanpolycollegeudr/"}
                >
                  <i className="hover:text-pink-500 fa-brands fa-instagram"></i>
                </Link>
                <Link
                  to={
                ...
                >
                  <i className="fa-brands hover:text-red-500 fa-youtube"></i>
                </Link>
              </div>
            </div>
              ...
              <div className="relative z-10 bg-white dark:bg-slate-600 rounded-xl shadow-lg p-8 text-gray-700 md:w-96">
                <form method="POST" className="flex flex-col space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="ring-1 ring-gray-300 w-full dark:text-white dark:bg-slate-700 transition-all duration-500 rounded-md px-4 py-2 mt-2 outline-none focus:ring-2 focus:ring-teal-300"
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      className="ring-1 ring-gray-300 w-full dark:text-white dark:bg-slate-700 transition-all duration-500 rounded-md px-4 mt-2 py-2 outline-none focus:ring-2 focus:ring-teal-300"
                  ...
                  <div>
                    ...
                    <input
                      type="email"
                      className="ring-1 ring-gray-300 dark:bg-slate-700 dark:text-white w-full transition-all duration-500 rounded-md px-4 py-2 mt-2 outline-none focus:ring-2 focus:ring-teal-300"
                  ...
                  <div>
                    ...
                    <textarea
                      className="ring-1 dark:bg-slate-700 transition-all duration-500 ring-gray-300 w-full dark:text-white rounded-md px-4 py-2 mt-2 outline-none focus:ring-2 focus:ring-teal-300"
                  ...
                  <button
                    className={`dark:text-white  w-[11rem] flex items-center justify-center transition-all duration-500 hover:shadow-3xl hover:bg-cyan-500 cursor-pointer self-end bg-cyan-700   pt-3  text-white font-bold rounded-lg px-6 py-2 uppercase text-sm`}
                    type="submit"
                    name="send"
                    onClick={PostData}
                  >
