      ...
      <div className="rounded-md p-10  shadow-lg dark:bg-blue-900 mt-4 bg-blue-100">
        ...
        >
          ...
          <div className="mt-12 flex justify-evenly items-center">
            <button
              type="submit"
              className="font-bold font-Crimson text-lg text-white bg-sky-500 uppercase rounded cursor-pointer hover:bg-blue-300 hover:shadow-3xl hover:text-blue-500 transition-all duration-700 dark:text-white bg-transparent p-2 px-5 dark:bg-blue-700 dark:hover:bg-blue-900"
