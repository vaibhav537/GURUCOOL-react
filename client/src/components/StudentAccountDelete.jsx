...
import { checkStudentPassword, deleteStudent } from "../utils/APIRoutes";

const StudentAccountDelete = ({ visible, onClose, studentEmail }) => {
  ...
  const handleDelete = async (e) => {
    e.preventDefault();
    const studentDelete = await fetch(deleteStudent, {
      method: "DELETE",
      headers: {
...
export default StudentAccountDelete;
