...
import { checkTeacherPassword, deleteTeacher } from "../utils/APIRoutes";

const TeacherAccountDelete = ({ visible, onClose, teacherEmail }) => {
  ...
  const handleDelete = async (e) => {
    e.preventDefault();
    const teacherDelete = await fetch(deleteTeacher, {
      method: "DELETE",
      headers: {
...
export default TeacherAccountDelete;
