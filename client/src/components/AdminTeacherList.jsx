...
import { fetchAdminTeacher, teacherAdminDelete } from "../utils/APIRoutes";
...
const AdminTeacherList = () => {
  ...
  const getTeacher = async () => {
    const response = await fetch(fetchAdminTeacher);
  ...
  const handleDeleteSubmit = async (id) => {
    ...
    try {
      const response = await fetch(`${teacherAdminDelete}/${id}`, {
        method: "DELETE",
      });
