...
import { generateOtp, registerStudent, verifyOtpUser } from "../utils/APIRoutes";
              ...
              <button
                ...
                className={` ${
                  disableButton
                    ...
                    : "font-bold font-Crimson text-lg text-white bg-sky-500 uppercase rounded  hover:bg-blue-300  hover:text-blue-500 transition-all duration-700 dark:text-white bg-transparent p-2 px-5 dark:bg-blue-700 dark:hover:bg-blue-900 cursor-pointer hover:shadow-3xl"
                }`}
