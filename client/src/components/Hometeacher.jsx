...
import TeacherAccountDelete from "./TeacherAccountDelete";
import { useNavigate } from "react-router-dom";
import { teacherTokenData } from "../utils/APIRoutes";
...
const Hometeacher = () => {
  ...
  useEffect(() => {
    const getTeacher = async () => {
      ...
      const teacherInformation = await fetch(teacherTokenData, {
        method: "POST",
        headers: {
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="flex relative justify-center w-screen h-[89vh] bg-green-100">
          <div className="">
