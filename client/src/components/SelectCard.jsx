...
import { fetchCategory, registerCategory } from "../utils/APIRoutes";
...
const SelectCard = () => {
  ...
  const getData = async () => {
    const response = await fetch(fetchCategory);
  ...
  const postCategory = async () => {
    ...
    try {
      const data = await fetch(`${registerCategory}/${teacherinfo._id}`, {
        method: "POST",
        headers: {
