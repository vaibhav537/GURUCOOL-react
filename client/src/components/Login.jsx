...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "GURUCOOOL : LOGIN"; // Set the title of the web page
  }, []);
  ...
  return (
    <div className="flex flex-col h-[89vh]   transition-all duration-1000 bg-slate-100 dark:bg-slate-600">
