...
import { fetchAdminStudent, studentAdminDelete } from "../utils/APIRoutes";
...
const AdminStudentList = () => {
  ...
  const getStudent = async () => {
    const response = await fetch(fetchAdminStudent);
  ...
  const handleDeleteSubmit = async (id) => {
    ...
    try {
      const response = await fetch(`${studentAdminDelete}/${id}`, {
        method: "DELETE",
      });
