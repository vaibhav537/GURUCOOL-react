...
import { checkStudentPassword, updateStudent } from "../utils/APIRoutes";
...
const StudentAccountUpdate = ({ visible, onClose, studentEmail }) => {
      ...
      const handlePasswordDialogClick = async (event) => {
        ...
        const matchPassword = await fetch(checkStudentPassword , {
          method: "POST",
          headers: {
      ...
      const handleUpdateTeacher = async (event) => {
        ...
        try {
          const updateStudentResult = await fetch(updateStudent, {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
          ...
          const updateStudentResponse = await updateStudentResult.json();
    
          if (updateStudentResponse.success === true) {
