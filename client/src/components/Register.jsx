...
const Radio = () => {
  ...
  useEffect(() => {
    document.title = "GURUCOOOL : REGISTER"; // Set the title of the web page
  }, []);
  ...
  return (
    <div className="flex flex-col bg-slate-100 dark:bg-slate-600 h-[109vh] pb-28 transition-all duration-1000">
      <div className="flex mt-20 mb-[3rem]">
