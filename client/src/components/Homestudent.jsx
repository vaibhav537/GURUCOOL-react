...
import StudentAccountDelete from "./StudentAccountDelete";
import StudentAccountUpdate from "./StudentAccountUpdate";
import { useNavigate } from "react-router-dom";
import { studentTokenData } from "../utils/APIRoutes";
...
const Homestudent = () => {
  ...
  useEffect(() => {
    const getStudent = async () => {
      ...
      const studentInformation = await fetch(studentTokenData, {
        method: "POST",
        headers: {
  ...
  return (
     <>
      ...
      />
      {loading ? (
        <div className="flex items-center justify-center w-screen h-[89vh] bg-blue-100">
        ...
        <div className="flex  justify-center w-screen h-[90vh] bg-blue-100">
          ...
          <div className="border-4 border-blue-800 w-[15rem] h-[30rem] shadow-2xl overflow-hidden bg-white/25 rounded-lg ">
            <div className="">
              <img src={studentPic} alt="..." className="w-full  h-full " />
            </div>
          </div>
          <div
